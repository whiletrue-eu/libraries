...
namespace WhileTrue.Classes.Framework
{
    ...
    public class ObservableObjectTest_PropertyAdapter_Static
    {
        ...
        private class TestProxy6 : ObservableObject
        {
            ...
            public IEnumerable<int> DeferredCollectionProperty => TestProxy6.deferredCollectionPropertyAdapter.GetCollection(this);
...
#pragma warning restore 219
        ...
        private class TestProxy10 : ObservableObject
        {
            ...
            static TestProxy10()
            {
                TestProxy10.collectionPropertyAdapter = ObservableObject.GetPropertyAdapterFactory<TestProxy10>().Create(
                    nameof(TestProxy10.CollectionProperty),
                    _ => from Item in _.Source.PropertyCollection where Item.Property==0 select Item,
            ...
            public IEnumerable<TestProxy10> CollectionProperty => TestProxy10.collectionPropertyAdapter.GetCollection(this);
