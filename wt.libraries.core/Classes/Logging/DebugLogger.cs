    ...
    public static class DebugLogger
    {
        ...
        private static string GetCallerId(object caller)
        {
            ...
            if (CallerReference == null)
            {
                ...
                Trace.WriteLine($"#{CallerReference.Id}: ID #{CallerReference.Id} was assigned to {caller}");
            }
        ...
        {
            DebugLogger.InternalDoIfLoggingEnabled(caller, loggingLevel, () => Trace.WriteLine($"{DebugLogger.GetCallerId(caller)}: {message()}"));
        }
