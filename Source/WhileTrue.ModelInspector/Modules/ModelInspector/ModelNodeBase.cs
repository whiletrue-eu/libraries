...
namespace WhileTrue.Modules.ModelInspector
{
    ...
    {
        private static readonly ObjectCache<ObjectCacheKey<object>,object, ModelNodeBase> nodeCache = new ObjectCache<ObjectCacheKey<object>, object, ModelNodeBase>((key,value) => CreateNode(value));

        internal static ModelNodeBase GetNode(object value)
        {
            return nodeCache.GetObject(new ObjectCacheKey<object>(value),value); //objectcachekey also supports null value
        }
