namespace WhileTrue.Classes.SCard
{
    ...
    public enum SCardError : uint
    {
        ...
        /// <summary>
        /// The network request is not supported. (API Error, sent by card mouse when protocol is not supported)
        /// </summary>
        RequestNotSupported = 0x32,

        /// <summary>
        /// Interface is unknown (API Error, sent when the smart card manager service is not running)
        /// </summary>
        UnknownInterface = 0x6b5,

        /// <summary>
        /// An internal consistency check failed.
        /// </summary>
        ConsistencyCheckFailed = 0x80100001,
        ...
        /// </summary>
        ReceiveBufferTooSmall = 0x80100019,
        ...
        /// </summary>
        UnsupportedCardWaring = 0x80100065,

        /// <summary>
        /// The smart card is not responding to a reset.
        /// </summary>
        UnresponsiveCardWarning = 0x80100066,

        /// <summary>
        /// Power has been removed from the smart card, so that further communication is not possible.
        /// </summary>
        UnpowererCardWarning = 0x80100067,

        /// <summary>
        /// The smart card has been reset, so any shared state information is invalid.
        /// </summary>
        ResetCardWarning = 0x80100068,

        /// <summary>
        /// The smart card has been removed, so that further communication is not possible.
        /// </summary>
        RemoveCardWarning = 0x80100069,

        /// <summary>
        /// Access was denied because of a security violation.
        /// </summary>
        SecurityViolationWarning = 0x8010006A,

        /// <summary>
        /// The card cannot be accessed because the wrong PIN was presented.
        /// </summary>
        WrongChvWarning = 0x8010006B,

        /// <summary>
        /// The card cannot be accessed because the maximum number of PIN entry attempts has been reached.
        /// </summary>
        ChvBlockedWarning = 0x8010006C,

        /// <summary>
        /// The end of the smart card file has been reached.
        /// </summary>
        EofWarning = 0x8010006D,

        /// <summary>
        /// The action was cancelled by the user.
        /// </summary>
        CancelledByUserWarning = 0x8010006E,

        /// <summary>
        /// No PIN was presented to the smart card.
        /// </summary>
        CardNotAuthenticatedWarning = 0x8010006F,
