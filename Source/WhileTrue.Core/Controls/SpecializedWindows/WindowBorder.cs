...
namespace WhileTrue.Controls
{
    ...
    public class WindowBorder : HeaderedContentControl
    {
        ...
        static WindowBorder()
        {
            ...
            NonClientControlsProperty = DependencyProperty.Register(
                "NonClientControls",
                typeof(object),
                typeof(WindowBorder),
                new FrameworkPropertyMetadata(false)
        ...
        {
            get { return this.GetValue(NonClientControlsProperty); }
            set { this.SetValue(NonClientControlsProperty, value); }
        }
    }
}