...
namespace WhileTrue.Controls
{
    ...
    public class Progress : ObservableObject, IProgress
    {
        ...
        public string Status
        {
            ...
            set { this.SetAndInvoke(()=>Status, ref this.status, value); }
        }
        ...
        public ICommand CancelCommand
        {
            ...
            set { this.SetAndInvoke(() => CancelCommand, ref this.cancelCommand, value); }
        }
        ...
        public double CurrentProgress
        {
            ...
            set { this.SetAndInvoke(() => this.CurrentProgress, ref this.currentProgress, value); }
        }
    }
}