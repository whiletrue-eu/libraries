...
namespace WhileTrue.Classes.Commanding._Unittest
{
    ...
    public class DelegateCommandTest
    {
        ...
        public void manual_test_in_real_window()
        {
        ...
        [Test]
        public void can_execute_changed_shall_be_called_on_requerysuggested()
        {
            ...
            Dispatcher.CurrentDispatcher.Invoke(DispatcherPriority.ApplicationIdle, (Action)delegate { });//Start dispatcher
        ...
        private class TestObject:ObservableObject
    {
            ...
            public bool Property
            {
                ...
                set { this.SetAndInvoke(()=>Property, ref this.property, value); }
            }
    }
