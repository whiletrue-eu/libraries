...
namespace WhileTrue.Classes.DragNDrop
{
    ...
    public class DragDropTargetFactory
    {
        ...
        /// </summary>
        public DragDropTargetFactory AddTypeHandler<ItemType>(DragDropEffects allowedEffects, DragDropEffect defaultEffect, Action<ItemType, DragDropEffect, AdditionalDropInfo> doDropAction)
        {
        ...
        /// </summary>
        public DragDropTargetFactory AddTypeHandler<ItemType>(Func<ItemType, DragDropEffects> allowedEffects, Func<ItemType, DragDropEffect> defaultEffect, Action<ItemType, DragDropEffect, AdditionalDropInfo> doDropAction)
        {
            this.handlers.Add(new DragDropTarget.DragDropItemHandler<ItemType>(allowedEffects, defaultEffect, doDropAction));
            return this;
        }
