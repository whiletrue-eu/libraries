...
namespace WhileTrue.Classes.DragNDrop
{
    internal class DragDropSourceAdapter : IDragDropSourceAdapter
    {
        ...
        public void DoDragDrop()
        {
            ...
            this.sourceHandler.NotifyDropped(ToDragDropEffect(DropEffect));
        }
        ...
        public void Dispose()
        {
            System.Windows.DragDrop.RemoveGiveFeedbackHandler(this.source, GiveFeedback);
            System.Windows.DragDrop.RemoveQueryContinueDragHandler(this.source, QueryContinueDrag);
