...
namespace WhileTrue.Classes.DragNDrop
{
    internal class DragDropTargetAdapter : IDragDropTargetAdapter
    {
        ...
        private void DragEnter(object sender, DragEventArgs e)
        {
            ...
            this.HandleDragStart(ToDropEffect(Effect));
            this.HandleDragUpdate(ToDropEffect(Effect), new DragPosition(e));
        ...
        private void Drop(object sender, DragEventArgs e)
        {
            ...
            this.targetHandler.DoDrop(e.Data, ToDropEffect(DropEffects), this.dragTargetHandler.GetAdditionalDropInfo(new DragPosition(e)));
