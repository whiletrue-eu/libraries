...
{
    public static class NotifyIconInteropHelper
    {
...
#pragma warning restore 169
        ...
        private class NotifyIconWindow : HwndSource, IDisposable, IMouseHookOwner
        {
            ...
            private class Registration
            {
                ...
                public INotifyIconCallback Callback { get; private set; }
...
//                this.mouseHook = new MouseHook(this);
            ...
            private readonly uint notificationAreaCreatedMessage = RegisterWindowMessage("TaskbarCreated");
...
//                                    }
                ...
                else if (msg == notificationAreaCreatedMessage)
                {
...
//                }
        ...
        private static NotifyIconWindow HookWindow
        {
            get
            {
        ...
        public static int CreateNotifyIcon(INotifyIconCallback messageCallback, Bitmap icon)
        {
            ...
            Shell_NotifyIcon(NotifyMessage.Add, ref IconData);
            Shell_NotifyIcon(NotifyMessage.SetVersion, ref IconData);
        ...
        {
            DestroyIcon(NotifyIconInteropHelper.iconHandles[iconID]);
            ...
            Shell_NotifyIcon(NotifyMessage.Modify, ref IconData);
        }
        ...
        public static void DeleteNotifyIcon(int iconID)
        {
            ...
            Shell_NotifyIcon(NotifyMessage.Delete, ref IconData);
        ...
        public static void SetFocusToNotifyIcon(int iconID)
        {
            ...
            Shell_NotifyIcon(NotifyMessage.SetFocus, ref IconData);
        }
    }
}