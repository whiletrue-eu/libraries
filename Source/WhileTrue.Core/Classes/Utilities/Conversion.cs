    ...
    public static class Conversion
    {
        ...
        public static string ToHexString(this byte[] data, string separator)
        {
            if (data != null)
            {
                ...
                {
                    Bytes.Add(string.Format("{0:X2}", Byte));
                }
        ...
        public static int ToInt32(byte[] value, int offset=0)
        {
            ...
            {
                throw new ArgumentException("not enough data to convert to (u)int", "offset");
            }
        ...
        public static short ToInt16(byte[] value, int offset=0)
        {
            ...
            {
                throw new ArgumentException("not enough data to convert to (u)short", "offset");
            }
        ...
        public static byte ToUInt8(byte[] value, int offset=0)
        {
            ...
            {
                throw new ArgumentException("not enough data to convert to (s)byte", "offset");
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new InvalidOperationException(string.Format("value of type {0} cannot be converted to type {1}", SourceType!=null?SourceType.FullName:"<null>", targetType.FullName));
                        }
                    }
                }
            }
