...
namespace WhileTrue.Classes.Framework
{
    partial class ObservableObject
    {
        ...
        /// </summary>
        protected interface IPropertyConstraintFactory<PropertyType>
        {
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            IPropertyConstraintFactory<PropertyType> AddValidation(Expression<Func<PropertyType, bool>> validation, Expression<Func<PropertyType, ValidationMessage>> message);
        }
        
        /// <summary>
        /// Flow interface for the <see cref="ObservableObject.AddValidationForProperty{PropertyType}"/> method
        /// </summary>
        protected interface IPropertyConstraintFactory<Property1Type,Property2Type>
        {
            /// <summary>
            /// Creates a validation method for the property
            /// </summary>
            ...
            /// </para>
            /// </remarks>
            IPropertyConstraintFactory<Property1Type, Property2Type> AddValidation(Expression<Func<Property1Type, Property2Type, bool>> validation, Expression<Func<Property1Type, Property2Type, ValidationMessage>> message);
        }
    }
}