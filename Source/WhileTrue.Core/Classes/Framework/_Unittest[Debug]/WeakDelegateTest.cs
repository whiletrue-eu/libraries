...
namespace WhileTrue.Classes.Framework._Unittest
{
    ...
    public class WeakDelegateTest
    {
        ...
        private class EventSource
        {
            ...
            public bool HandlerIsRegistered
            {
                get { return this.Event != null; }
            }
        ...
        private class EventSink
        {
            ...
            public bool EventWasInvoked
            {
                get { return eventWasInvoked; }
            }
        }
        ...
        public void performance_shall_not_degrade_extremely_when_using_weak_delegates()
        {
            ...
            Debug.WriteLine(string.Format("Add: Normal:{0}, Weak: {1} / {2}", AddHandlers, AddHandlersWeak, AddHandlersWeak / (1d + AddHandlers)));
            Debug.WriteLine(string.Format("Add: Normal:{0}, Weak: {1} / {2}", InvokeHandlers, InvokeHandlersWeak, InvokeHandlersWeak / (1d + InvokeHandlers)));
            Debug.WriteLine(string.Format("Add: Normal:{0}, Weak: {1} / {2}", RemoveHandlers, RemoveHandlersWeak, RemoveHandlersWeak / (1d + RemoveHandlers)));
