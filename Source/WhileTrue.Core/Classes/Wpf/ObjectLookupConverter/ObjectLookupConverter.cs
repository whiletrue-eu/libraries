...
namespace WhileTrue.Classes.Wpf
{
    ...
    {
       private readonly ObservableCollection<ObjectLookupItemBase> lookupItems = new ObservableCollection<ObjectLookupItemBase>();
        ...
        /// </summary>
        public ObservableCollection<ObjectLookupItemBase> LookupItems
        {
            get { return this.lookupItems; }
        }
            ...
            try
            {
                foreach (ObjectLookupItemBase LookupItem in this.lookupItems)
                {
                    ...
                    else if (LookupItem is ObjectLookupItem)
                    {
                        ...
                        Type KeyType = Item.Key != null ? Item.Key.GetType() : null;
                        Type ValueType = value != null ? value.GetType() : null;

                        if (KeyType == ValueType)
                        {
                            if (Equals(Item.Key, value))
                            {
                                return LookupItem.Value;
                            }
                        }
                        else if (KeyType != null && ValueType != null)
                        {
                            ...
                            else if (KeyConverter.CanConvertFrom(ValueType))
                            {
                                ...
                                if (Equals(Item.Key, ConvertedValue))
                                {
                                    return LookupItem.Value;
                                }
                            }
        ...
        private object ConvertBack(object value)
        {
            foreach (ObjectLookupItemBase LookupItem in this.lookupItems)
            {
                ...
                else if (LookupItem is ObjectLookupItem)
                {
                    ...
                    Type DestinationType = Item.Value != null ? Item.Value.GetType() : null;
                    Type ValueType = value != null ? value.GetType() : null;
                    ...
                    else if (DestinationType != null && ValueType != null)
                    {
                        ...
                        if (Converter.CanConvertTo(ValueType))
                        {
                            ...
                            if (Equals(ConvertedValue, value))
                            {
                                return Item.Key;
                            }
                        }
                        else if (Converter.CanConvertFrom(ValueType))
                        {
                            ...
                            if (Equals(Item.Value, ConvertedValue))
                            {
                                return Item.Key;
                            }
                        }
