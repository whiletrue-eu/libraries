...
namespace WhileTrue.Classes._Unittest
{
    public class BackingData : ObservableObject
    {
        public BackingData()
        {
            ...
            this.AddValidationForProperty(() => Int)
            ...
            this.AddValidationForProperty(() => String)
        ...
        public int Int
        {
            ...
            set { this.SetAndInvoke(()=>Int, ref this.intValue, value); }
        }
        ...
        public string String
        {
            ...
            set { this.SetAndInvoke(()=>String, ref this.stringValue, value); }
        }      
        ...
        public string FileOrig
        {
            ...
            set { this.SetAndInvoke(()=>File, ref this.file, value); }
        }
        public string File
        {
