...
namespace WhileTrue.Components.SmartCardService
{
    ...
    public class SmartCardService : ObservableObject, ISmartCardService
    {
        ...
        private readonly CardReaderCollection readers = new CardReaderCollection();
        private readonly SmartCardCollection smartCards = new SmartCardCollection();
        ...
        /// </summary>
        public CardReaderCollection CardReaders
        {
        ...
        /// </summary>
        public SmartCardCollection SmartCards
        {
            get { return this.smartCards; }
        }
