    ...
    public sealed class T0ProtocolParameters : ProtocolParametersBase
    {
        ...
        public byte? WaitingTimeInteger
        {
            ...
            set
            {
                ...
                this.InvokePropertyChanged(()=>WaitingTimeInteger);
                this.InvokePropertyChanged(()=>WaitingTimeIntegerValue);
            }
        }

        public byte WaitingTimeIntegerValue
        {
            get
            {
                return this.GetInterfaceByte(0, InterfaceByteType.Tc) ?? 10;
            }
        }
