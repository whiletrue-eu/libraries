  ...
  */
    ...
    public class AtrDirDataReferenceHistoricalCharacters : AtrHistoricalCharactersBase
    {
        ...
        public byte DirDataReference
        {
            ...
            set
            {
                this.SetAndInvoke(()=>DirDataReference, ref this.dirDataReference, value);
                this.UpdateData();
            }
        }
        ...
        protected override void HistoricalCharactersChanged(byte[] historicalCharacters1)
        {
            ...
            try
            {
                ...
                if (HistoricalCharacters.Length > 0 && HistoricalCharacters[0] == 0x10)
                {
                    this.IsApplicable = true;
                    if (HistoricalCharacters.Length >= 2)
                    {
                        this.DirDataReference = HistoricalCharacters[1];
                    }
                    if (HistoricalCharacters.Length > 2)
                    {
