...
namespace WhileTrue.Classes.Win32
{
    ...
    internal abstract class Win32
    {
        ...
        private static extern bool PeekMessage(out Msg lpMsg, IntPtr hWnd, Wm wMsgFilterMin, Wm wMsgFilterMax,
            Pm wRemoveMsg);
...
#define ICON_SMALL2         2*/
        ...
        {
            message.Result = (IntPtr) SendMessage(message.HWnd, message.Msg, message.WParam, message.LParam);
        }
        ...
        {
            return SendMessage(control.Handle, (int) msg, wParam, lParam);
        }
        ...
        {
            DoEvents(control, message, message);
        }
        ...
        {
            foreach (var Message in messages) DoEvents(Message);
        }
        ...
        {
            DoEvents(null, minMessage, maxMessage);
        }
        ...
        {
            var Handle = control == null ? IntPtr.Zero : control.Handle;
            Msg Message;
            while (PeekMessage(out Message, Handle, minMessage, maxMessage, Pm.Remove))
            {
