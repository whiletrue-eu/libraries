...
namespace WhileTrue.Classes.Wpf
{
    ...
    ///     This extension provides the correct routed event for the given EventName, which is the name of the property that
    ///     changes shall be caught for.
    /// </summary>
    public class PropertyChangedEventExtension : MarkupExtension
    {
        ...
        {
            return PropertyChangedRoutedEventFactory.GetRoutedEvent($"{EventName}Changed");
        }
    }
}