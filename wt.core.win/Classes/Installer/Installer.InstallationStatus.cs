namespace WhileTrue.Classes.Installer
{
    ...
    {
        /// <summary>
        ///     State while the installation is performed. The installation consists of (optional) download and installation of
        ///     missing packages
        /// </summary>
        public class InstallationStatus : StatusBase
        {
            ...
            {
                /// <summary />
                public DownloadingStatus(int numberOfPackagesToDownload, double acquiredPackages,
                    string acquisitionStatus)
                {
                    NumberOfPackagesToDownload = numberOfPackagesToDownload;
                ...
                /// </summary>
                public double AcquiredPackages { get; }
            ...
            public class InstallingStatus : InstallationStatusBase
            {
                ...
                {
                    NumberOfPackagesToInstall = numberOfPackagesToInstall;
