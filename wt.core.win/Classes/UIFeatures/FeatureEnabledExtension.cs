...
{
    /// <summary>
    ///     Connects an <c>IsEnabled</c> property to the information provided by the associated
    ...
    public sealed class FeatureEnabledExtension : UiFeatureBindingExtensionBase
    {
        ...
        private sealed class EnabledValueWrapper : ValueWrapperBase
        {
            ...
            public override object Value => Manager == null || Manager.IsEnabled(Context);
        }
    }
}