...
namespace WhileTrue.Classes.DragNDrop
{
    ...
    public interface IDragDropSource
    {
        ...
        /// <summary>
        ///     Notifies the source that the object was dropped, and about the drop effect. If required, the source can act upon
        ///     this notification (e.g. remove its data when object was moved)
        /// </summary>
